...
INSERT INTO `invoice` VALUES (100,1,6,4,'2.5',5000,'2020-02-09 14:47:32','2020-02-25 14:47:32',0);
...
CREATE TABLE `user` (
  ...
  `isWizard` tinyint(4) NOT NULL DEFAULT '0',
  `Pic` blob,
  PRIMARY KEY (`UserID`),
...
INSERT INTO `user` VALUES (2,'JohnyTest','Jon','Testerman','132 Debugger Dr','Cincinnati','OH',45200,'513-555-7895','Tester@testing.com','test123',0,NULL),(3,'MikeUserson','Mike','Userson','123 Drive','Cincinnati','OH',45200,'555-555-5555','test@testing.com','using',0,NULL),(4,'JefferyB','Jeff','BB','','','',0,'','test@testing.com','using',0,NULL),(5,'Someone','Guy','bleh','','','',0,'','test@testing.com','using',0,NULL);
...
-- Dump completed on 2020-02-18 16:50:57
